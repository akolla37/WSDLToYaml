    ...
    for (let k = 0; k < defServices.length; k++) {
        ...
        if (service['undefined'].name == serviceName) {
            ...
            for (let m = 0; m < portTypeOperations.length; m++) {
                ...
                let boXMLNS = bindingOper.xmlns || localNamespaces;
                ...
                if (op.operation.input) {
                    ...
                    inputMessage = dictionary.resolveNameInNamespace(inputMessage, localNamespaces, namespaces, ptTNS);
                    ...
                    if (isDocumentStyle) {
                        ...
                        let opMessageInput = getMessagePartType(inputMessage, messages, inputPartList, namespaces, inputContentParts, dict, tns);
                ...
                if (op.operation.output) {
                    ...
                    // must resolve the namespace here as this will normalise use of duplicate namespaces and prefixes
                    outputMessage = dictionary.resolveNameInNamespace(outputMessage, localNamespaces, namespaces, ptTNS);
                    ...
                    if (isDocumentStyle) {
                        ...
                        let opMessageOutput = getMessagePartType(outputMessage, messages, outputPartList, namespaces, outputContentParts, dict, tns);
                ...
                if (op.operation.fault) {
                    ...
                    for (let n = 0; n < faultLen; n++) {
                        ...
                        // must resolve the namespace here as this will normalise use of duplicate namespaces and prefixes
                        faultMessage = dictionary.resolveNameInNamespace(faultMessage, localNamespaces, namespaces, ptTNS);
                        ...
                        if (isDocumentStyle) {
                            ...
                            let opMessageFault = getMessagePartType(faultMessage, messages, faultPartList, namespaces, faultContentParts, dict, tns);
                ...
                if (inputMessage) {
                    ...
                    if (inputHeaders) {
                        ...
                        for (let x = 0; x < headers.length; x++) {
                            ...
                            let headerMessageName = dictionary.resolveNameInNamespace(header['undefined'].message, boXMLNS, namespaces, boTNS);
                            ...
                            if (headerMessage) {
                                ...
                                for (let z = 0; z < headerParts.length; z++) {
                                    ...
                                    if (hdrPartName == headerPart) {
                                        ...
                                        if (hdrElemName) {
                                            let hdrElemNsName = dictionary.resolveNameInNamespace(hdrPart['undefined'].element, headerMessage.xmlns, namespaces, headerMessage.tns || tns);
                ...
                if (outputMessage) {
                    ...
                    if (!outputHeaders) {
                        ...
                        for (let x = 0; x < headersOut.length; x++) {
                            ...
                            let headerOutMessageName = dictionary.resolveNameInNamespace(headerOut['undefined'].message, boXMLNS, namespaces, boTNS);
                            ...
                            if (headerOutMessage) {
                                ...
                                for (let z = 0; z < headerOutParts.length; z++) {
                                    ...
                                    if (hdrOutPartName == headerOutPart) {
                                        ...
                                        if (hdrOutElemName) {
                                            let hdrOutElemNsName = dictionary.resolveNameInNamespace(hdrOutPart['undefined'].element, headerOutMessage.xmlns, namespaces, headerOutMessage.tns || tns);
                ...
                if (faultMessages.length > 0  || options.mapSOAPFaults) {
                    ...
                    if (!faultHeaders) {
                        ...
                        for (let x = 0; x < headersFault.length; x++) {
                            ...
                            let headerFaultMessageName = dictionary.resolveNameInNamespace(headerFault['undefined'].message, boXMLNS, namespaces, boTNS);
                            ...
                            if (headerFaultMessage) {
                                ...
                                for (let z = 0; z < hpartFaultLen; z++) {
                                    ...
                                    if (hdrFaultPartName == headerFaultPart) {
                                        ...
                                        if (hdrFaultElemName) {
                                            let hdrFaultElemNsName = dictionary.resolveNameInNamespace(hdrFaultPart['undefined'].element, headerFaultMessage.xmlns, namespaces, headerFaultMessage.tns || tns);
            ...
            for (let messageName in usedMessages) {
                ...
                for (let i = 0; i < parts.length; i++) {
                    ...
                    let partNSName = dictionary.resolveNameInNamespace(partType, msg.xmlns ? msg.xmlns : namespaces, namespaces, msg.xmlns || tns);
                    ...
                    if (partNameOK) {
                        ...
                        if (dictEntry) {
                            // found a custom type
                            let referencingContext = dict.elementNS[partNSName] ? dict.elementNS[partNSName].xml : null;
...
function getMessagePartType(messageNsName, messages, partList, namespaces, contentPartList, dict, tns) {
    let req = dict.req;
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (contentPartList.indexOf(opPartName) < 0) {
                ...
                if (partNameOK) {
                    ...
                    if (opMessage.xmlns) {
                        opPartType = dictionary.resolveNameInNamespace(opPartType, opMessage.xmlns, namespaces, opMessage.tns || tns);
                    } else {
